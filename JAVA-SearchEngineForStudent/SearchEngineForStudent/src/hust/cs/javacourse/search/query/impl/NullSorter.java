 ...
 * @author MYH
 */
public class NullSorter implements Sort {
    ...
    public static void main(String[] args){
        AbstractHit hit1 = new Hit();
        AbstractHit hit2 = new Hit();
        AbstractHit[] hits = new AbstractHit[2];
        hits[0] = hit1; hits[1] = hit2;
        Sort sorter = new NullSorter();
